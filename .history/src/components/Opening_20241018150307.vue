<template>
  ...
  <div class="card-page mb-3" data-aos="zoom-in" data-aos-duration="1500">
      ...
      <div class="akad">
        ...
        <form action="">
          ...
          <div
            ...
            style="font-family: 'Quicksand', sans-serif; font-size: 1em"
          >
          ...
          <div class="form-group d-flex justify-content-end">
            <button class="btn btn-kirim mt-3">
    ...
    <div class="p-4">
      ...
      data-aos-duration="2000"
    >
      <h3 style="text-align: center; font-family: 'Baliana', sans-serif; font-size: 2em !important; color: #cabc65;">
        Wishes for You
      </h3>
      <div class="separator-horizontal" style="width: 100% !important; background-colorr: #cabc65;">
