<template>
  ...
  <div class="card-page" data-aos="zoom-in" data-aos-duration="1500">
    ...
    <div
      ...
      data-aos-duration="1500"
    >
      <p class="text-title">Reservasi</p>
    </div>
      ...
      <div class="akad px-3 pb-2">
        ...
        <div class="form-group d-flex justify-content-center">
          <button @click="openModal" class="btn btn-kirim mt-4">
            <i class="fa fa-book me-2"></i>Konfirmasi Kehadiran
          </button>
        </div>
      </div>
    ...
    <img class="hero-bottom" src="../assets/vectors/hero-bottom.png" alt="" style="margin-top: 200px;" />
