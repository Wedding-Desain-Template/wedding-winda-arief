<template>
  ...
  <div class="card-page-ayat p-3" data-aos="zoom-in" data-aos-duration="1500">
    ...
    >
      <div class="border-card-date">
        ...
        >
          ...
          <h6 style="font-weight: bold; letter-spacing: 1px; text-transform: uppercase;">SAbTU</h6>
        ...
        <img class="art-date-top" src="../assets/vectors/art-date-top.png" alt="" />
    ...
    >
      <div class="border-card-date-2">
        <img class="art-date-bottom" src="../assets/vectors/art-date-bottom.png" alt="" />
        ...
        <div
          ...
          data-aos-duration="2000"
        >
          <h1 class="title-akad" style="margin-top: 20px !important;">Resepsi</h1>
          <h6 style="font-weight: bold; letter-spacing: 1px; text-transform: uppercase;">SAbTU</h6>
          <div class="separator-horizontal"></div>
  ...
  <!-- Galery -->
  <div class="card-page-ayat p-3" data-aos="zoom-in" data-aos-duration="1500">
    <img src="../assets/vectors/flower-right.png" class="flower-right-1" alt="">
    <div
      class="title-box"
      data-aos="zoom-in"
      data-aos-delay="200"
  ...
  <div class="card-page" data-aos="zoom-in" data-aos-duration="1500">
    ...
    <div class="px-4" style="padding-bottom: 60px;">
      ...
      data-aos-duration="2000"
    >
      <h3 style="text-align: center; font-family: 'Baliana', sans-serif; font-size: 2em !important;">
        Wishes for You
      </h3>
      <div class="separator-horizontal" style="width: 100% !important;">
...
document.getElementById('copy-button').addEventListener('click', function() {
  // Text yang ingin disalin (misalnya nomor rekening)
  var rekening = '123-456-7890'; // Ganti dengan nomor rekening yang sesuai
  ...
  // Menghapus elemen input setelah penyalinan
  document.body.removeChild(tempInput);
  
  // Mengubah teks tombol
  var button = document.getElementById('copy-button');
  button.innerHTML = '<i class="fa fa-check me-2"></i>Rekening di salin';
  
  // Opsional: Reset teks tombol setelah beberapa detik
  setTimeout(function() {
    button.innerHTML = '<i class="fa fa-copy me-2"></i>Salin Rekening';
