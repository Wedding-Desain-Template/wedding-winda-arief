  ...
  <div id="invitation-content" class="invitation">
    <div class="card-page p-5" id="page-home">
      ...
      <div class="card-date mt-1 mb-4" id="card-date">
        <div>
            <div class="box-date hari" id="hari">0</div>
            <p class="box-text">Hari</p>
        </div>
        <div>
            <div class="box-date jam" id="jam">0</div>
            <p class="box-text">Jam</p>
        </div>
        <div>
            <div class="box-date menit" id="menit">0</div>
            <p class="box-text">Menit</p>
        </div>
        <div>
            <div class="box-date detik" id="detik">0</div>
...
function startCountdown(targetDate) {
            ...
            function updateCountdown() {
                ...
                if (distance < 0) {
                    document.getElementById("card-date").innerHTML = "<p>Acara telah dimulai!</p>";
                ...
                hariElement.innerText = days;
                jamElement.innerText = hours;
                menitElement.innerText = minutes;
                detikElement.innerText = seconds;
            }
