<template>
  ...
  <div id="invitation-content" class="invitation">
    <div class="card-page p-5" id="page-home">
      ...
      <img class="img-mempelai" src="../assets/img/foto-5.jpg" alt="" />
  ...
  <img class="img-galery" :src="require('@/assets/img/foto-2.jpg')" alt="Foto 2" />
</a>
...
export default {
  ...
  data() {
    return {
      ...
      isCopiedAlamat: false, // Variabel untuk menandakan apakah rekening sudah disalin
