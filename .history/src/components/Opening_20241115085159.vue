...
export default {
  ...
  data() {
    return {
      targetDate: new Date("2024-11-20T00:00:00").getTime(), // Ubah tanggal acara sesuai kebutuhan
      countdown: {
        hari: 0,
        jam: 0,
        menit: 0,
      ...
      interval: null, // Untuk menyimpan interval timer
    };
  },
  methods: {
    updateCountdown() {
      ...
      if (distance <= 0) {
        clearInterval(this.interval); // Hentikan timer jika waktu habis
  ...
  mounted() {
    // Jalankan fungsi countdown saat komponen dimuat
    this.updateCountdown();
    this.interval = setInterval(this.updateCountdown, 1000);
  },
  beforeDestroy() {
    // Bersihkan interval jika komponen dihancurkan
