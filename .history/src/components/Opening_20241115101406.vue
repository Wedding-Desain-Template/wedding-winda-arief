<template>
  ...
  <div id="invitation-content" class="invitation">
    <div class="card-page p-5" id="page-home">
      ...
      <div class="card-date mt-1 mb-4" id="card-date">
        <div>
          <div class="box-date">{{ countdown.hari }}</div>
          <p class="box-text">Hari</p>
        </div>
        <div>
          <div class="box-date">{{ countdown.jam }}</div>
          <p class="box-text">Jam</p>
        </div>
        <div>
          <div class="box-date">{{ countdown.menit }}</div>
          <p class="box-text">Menit</p>
        </div>
        <div>
          <div class="box-date">{{ countdown.detik }}</div>
    ...
    >
      <div class="border-card-date-2">
        ...
        <div
          ...
          data-aos-duration="2000"
        >
          <h1 class="title-akad" style="margin-top: 20px !important">
            Resepsi
          </h1>
          <h6
            style="
  ...
  <div class="card-page" data-aos="zoom-in" data-aos-duration="1500">
    ...
    <div
      class="card-rsvp-wish mt-4"
      data-aos="flip-left"
      data-aos-easing="ease-out-cubic"
      data-aos-duration="2000"
      data-aos-delay="100"
    >
      <!-- <div class="akad px-3 pb-2">
        ...
        <form action="">
          ...
          <h1 class="title-rsvp mt-4">Kirimkan Doa</h1>
          ...
          <div class="form-group d-flex justify-content-end">
            <button class="btn btn-kirim mt-4">
              <i class="fa fa-envelope me-2"></i>Kirim
            </button>
          </div>
        </form>
      </div> -->
      <div class="akad px-3 pb-2">
        <h1 class="title-rsvp">Konfirmasi Kehadiran</h1>
        <!-- Tombol RSVP untuk membuka modal Google Form -->
        <div class="form-group d-flex justify-content-center">
          <button @click="openModal" class="btn btn-kirim mt-4">
            <i class="fa fa-envelope me-2"></i>Konfirmasi Kehadiran
          </button>
        </div>
      </div>
      <div v-if="isModalOpen" class="modal-overlay" @click="closeModal">
        <div class="modal-content" @click.stop>
          <button @click="closeModal" class="close-btn btn">Close</button>
          <iframe
            src="https://forms.gle/PhxbaBbDt9WVZTBY7"
            width="100%"
            height="600"
            frameborder="0"
            allowfullscreen
  ...
  <div class="card-page-ayat p-3" data-aos="zoom-in" data-aos-duration="1500">
    ...
    <div class="wedding-gift px-3 pb-4" id="wedding-gift">
  <div class="amplop-digital">
    <p class="text-to-2 mt-3" data-aos="fade-down" data-aos-delay="100" data-aos-duration="1500">
      Amplop Digital
    </p>
    <div class="atm-card mt-3" data-aos="fade-right" data-aos-delay="300" data-aos-duration="1500">
      ...
      <div class="form-group d-flex justify-content-end mt-4">
        <button class="btn-salin" id="copy-rekening" @click="copyRekening">
          ...
          {{ isCopied ? "Rekening Disalin" : "Salin Rekening" }}
        </button>
      </div>
    </div>
  </div>
  ...
  <div class="hadiah">
    <p class="text-to-2 mt-4" data-aos="fade-down" data-aos-delay="100" data-aos-duration="1500">
      Kirim Hadiah
    </p>
    <div class="atm-card mt-3" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1500">
      ...
      <div class="card-details mt-2">
        <b>{{ pemilikHadiah }}</b>
        <p><span id="account-number" style="font-size: 0.9em !important">No HP : {{ nohp }}</span></p>
        <p><span id="address" style="font-size: 0.9em !important">{{ alamat }}</span></p>
      </div>
      <div class="form-group d-flex justify-content-end mt-4">
        <button class="btn-salin" id="copy-alamat" @click="copyAlamat">
          <i class="fa fa-copy me-2"></i>
          {{ isCopied ? "Alamat Disalin" : "Salin Alamat" }}
        </button>
      </div>
    </div>
  </div>
  ...
  <!-- ThankYou -->
  <div class="card-page p-4" data-aos="zoom-in" data-aos-duration="1500">
    <h5
      class="nama-mempelai"
...
export default {
  ...
  data() {
    return {
      ...
      interval: null,
      isModalOpen: false, // Variabel untuk mengontrol modal
      isCopied: false, // Variabel untuk menandakan apakah rekening sudah disalin
  ...
  methods: {
    updateCountdown() {
      ...
      this.countdown.jam = Math.floor(
        (distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)
      );
      this.countdown.menit = Math.floor(
    ...
    // Fungsi untuk menyalin rekening ke clipboard
    copyRekening() {
      const copyButton = document.getElementById("copy-rekening"); // Pastikan tombol ada
      if (!copyButton) {
      ...
      tempInput.value = this.rekening; // Ganti dengan rekening yang sesuai
      tempInput.select();
    ...
    copyAlamat() {
      const copyButton = document.getElementById("copy-alamat"); // Pastikan tombol ada
      if (!copyButton) {
        console.error("Copy alamat not found");
        return;
      }
      const tempInput = document.createElement("input");
      document.body.appendChild(tempInput);
      tempInput.value = this.alamat; // Ganti dengan rekening yang sesuai
      tempInput.select();
      document.execCommand("copy");
      document.body.removeChild(tempInput);
